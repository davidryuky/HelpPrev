...
import { Lock, Search, CheckCircle, Clock, FileText, X, Save, RefreshCw, Loader2, Trash2, Filter, Briefcase, Eye, Smartphone, Monitor, Globe, Fingerprint } from 'lucide-react';
...
export const Admin: React.FC = () => {
  ...
  const calculateScore = (metadataStr?: string) => {
    ...
    try {
      ...
      // Resolução (Telas maiores/high density costumam ser dispositivos melhores)
      if (meta.screen) {
