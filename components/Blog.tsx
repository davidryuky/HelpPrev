...
const posts = [
  {
    ...
    content: (
      <>
        ...
        <div className="bg-amber-50 p-8 rounded-xl border border-amber-200 mt-10">
          <h3 className="text-xl font-bold text-slate-900 mb-2">Não desista do seu direito</h3>
          <p className="text-slate-700 mb-4">
            Se você recebeu um "não" do INSS, traga sua carta de indeferimento para nós. Analisamos gratuitamente se houve erro na decisão.
          </p>
        </div>
      </>
    )
  },
  {
    ...
    content: (
      <>
        <p className="mb-6 text-lg leading-relaxed text-slate-700">
          O tema "Revisão da Vida Toda" tomou conta dos noticiários jurídicos nos últimos anos e gerou muita ansiedade em aposentados. Trata-se da possibilidade de incluir no cálculo da sua aposentadoria todas as contribuições feitas ao longo da sua vida, inclusive as anteriores a julho de 1994 (início do Plano Real).
        </p>

        <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4 border-l-4 border-amber-500 pl-4">O que é essa revisão?</h2>
        <p className="mb-6 leading-relaxed text-slate-700">
          Em 1999, o governo mudou a regra de cálculo e decidiu ignorar os salários de contribuição anteriores a Julho de 1994. Isso prejudicou quem ganhava bem no início da carreira e passou a ganhar menos depois. A tese da Revisão da Vida Toda busca aplicar a regra mais vantajosa para o segurado, considerando <strong>todo</strong> o histórico contributivo.
        </p>

        <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4 border-l-4 border-amber-500 pl-4">Para quem vale a pena?</h2>
        <p className="mb-6 leading-relaxed text-slate-700">
          Esta revisão <strong>não é automática</strong> e nem vantajosa para todos. Em alguns casos, ela pode até diminuir o valor do benefício. Ela é indicada especificamente para segurados que:
        </p>
        <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
          <li>Possuem altas contribuições (teto ou próximo) antes de 1994;</li>
          <li>Passaram a ganhar menos ou ficaram sem contribuir após 1994;</li>
          <li>Se aposentaram há menos de 10 anos (prazo decadencial).</li>
        </ul>

        <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4 border-l-4 border-amber-500 pl-4">O Risco de Agir sem Cálculo</h2>
        <p className="mb-6 leading-relaxed text-slate-700">
          Entrar com essa ação sem ter certeza matemática é um risco enorme. Você pode perder tempo e dinheiro com custas processuais. O segredo está no <strong>Cálculo Prévio</strong>.
        </p>
        <p className="mb-6 leading-relaxed text-slate-700">
          Na HelpPrev, utilizamos software avançado para simular sua aposentadoria com e sem a revisão. Só recomendamos a ação judicial se a vantagem financeira for clara e expressiva para você.
        </p>
      </>
    )
  },
  {
    ...
    content: (
      <>
        ...
        <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4 border-l-4 border-amber-500 pl-4">O Mito da "Miserabilidade"</h2>
        <p className="mb-6 leading-relaxed text-slate-700">
          A lei diz que a renda familiar per capita deve ser inferior a 1/4 do salário mínimo. O INSS segue essa regra matemática friamente e nega a maioria dos pedidos que ultrapassam esse valor por centavos.
        </p>
        <p className="mb-6 leading-relaxed text-slate-700">
          Porém, a <strong>Justiça tem um entendimento mais humano</strong>. Nos tribunais, o critério de renda é flexibilizado. Se a família comprovar gastos elevados com remédios, fraldas, tratamentos, aluguel e alimentação especial, é possível deduzir esses valores da renda bruta. Assim, muitas famílias que tiveram o BPC negado no posto do INSS conseguem o benefício via judicial.
        </p>

        <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4 border-l-4 border-amber-500 pl-4">A Importância do CadÚnico</h2>
        <p className="mb-6 leading-relaxed text-slate-700">
          Para pedir o BPC, é obrigatório estar inscrito e com os dados atualizados no Cadastro Único (CadÚnico). Um erro comum é ter divergências entre o que você declarou no CRAS e a realidade dos fatos. Antes de pedir o benefício, revisamos seu CadÚnico para evitar contradições que possam bloquear seu pagamento.
        </p>

        <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4 border-l-4 border-amber-500 pl-4">Pessoas com Deficiência</h2>
        <p className="mb-6 leading-relaxed text-slate-700">
          Para o BPC, não basta ter a doença. É preciso comprovar que a deficiência impõe barreiras de longo prazo (mínimo de 2 anos) que impedem a participação plena na sociedade. Laudos médicos genéricos não funcionam aqui. Ajudamos você a preparar a documentação médica correta para convencer o perito.
        </p>
      </>
    )
  },
  {
    ...
    content: (
      <>
        ...
        <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4 border-l-4 border-amber-500 pl-4">Auxílio por Incapacidade Temporária (Antigo Auxílio-Doença)</h2>
        <p className="mb-6 leading-relaxed text-slate-700">
          É destinado ao trabalhador que fica impedido de trabalhar por mais de 15 dias consecutivos devido a doença ou acidente. A palavra-chave aqui é <strong>TEMPORÁRIO</strong>. O INSS entende que, com o tratamento, você vai se recuperar e voltar ao mercado de trabalho. Por isso, esse benefício tem data para acabar (DCB).
        </p>

        <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4 border-l-4 border-amber-500 pl-4">Aposentadoria por Incapacidade Permanente (Antiga Invalidez)</h2>
        <p className="mb-6 leading-relaxed text-slate-700">
          É devida quando a incapacidade é total e definitiva, sem previsão de recuperação ou reabilitação para outra função que garanta a subsistência. O segurado não tem mais condições de trabalhar em nenhuma função.
        </p>

        <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4 border-l-4 border-amber-500 pl-4">O "Pulo do Gato": A Conversão</h2>
        <p className="mb-6 leading-relaxed text-slate-700">
          Raramente o INSS concede a aposentadoria por invalidez de imediato. Geralmente, começa-se recebendo o auxílio-temporário. Se a condição se agravar ou se tornar crônica sem cura, deve-se pedir a <strong>conversão</strong> em aposentadoria permanente.
        </p>
        <p className="mb-6 leading-relaxed text-slate-700">
          Outro ponto importante é o valor: dependendo da regra de cálculo (pré ou pós Reforma), a Aposentadoria por Invalidez pode pagar menos que o Auxílio-Doença. Por isso, antes de pedir a conversão, é vital fazer as contas. Na HelpPrev, analisamos qual cenário é mais vantajoso financeiramente para o seu caso.
        </p>
      </>
    )
  }
